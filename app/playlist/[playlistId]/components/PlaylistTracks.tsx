...
const PlaylistTracks: React.FC<Props> = ({ tracks }) => {
  return (
    <section className="flex w-full flex-col items-start justify-start">
      <Heading title="Playlist content" description={`Tracks`} margin={false} />
            ...
            <div className="m-5 flex w-60 flex-row justify-start">
              ...
              <div className="flex flex-col">
                <a
                  ...
                  href={`${process.env.NEXT_PUBLIC_URL}/track/${track?.track?.id}`}
                >
                  {track?.track?.name}
                </a>
