...
const Tier: React.FC<TierProps> = ({ items, name }) => {
  const [tier, songs] = useDragAndDrop<
    HTMLUListElement,
  ...
  return (
    <div className="flex w-full flex-row rounded-md border border-slate-700">
      <div className="flex min-h-full w-32 min-w-[7rem] items-center justify-center border-r border-slate-700">
